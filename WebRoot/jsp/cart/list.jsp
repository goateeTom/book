	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/book/CartItemServlet/batchDelete?cartItemIds=" + id;
			}
		} else {
...
function sendUpdateQuantity(id, quantity) {
	$.ajax({
		async:false,
		cache:false,
		url:"/book/CartItemServlet/updateQuantity",
...
if(bool) {
	...
	$(":checkbox[name='checkboxBtn']").removeProp("checked");
	}
}
...
function batchDelete() {
	...
	location = "/book/CartItemServlet/batchDelete?cartItemIds=" + cartItemIdArray;
}
...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		...
		<td>
			<a href="<c:url value='/CartItemServlet/batchDelete?cartItemIds=${cartItem.cartItemId }'/>">删除</a>
		</td>
	</tr>
</c:forEach>
	...
	<form id="jieSuanForm" action="<c:url value='/CartItemServlet/loadCartItems'/>" method="post">
